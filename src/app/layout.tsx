...
export const metadata: Metadata = {
  title: "Luxe Stay - Luxury Hotel Accommodations",
  description: "Experience 5-star luxury at Luxe Stay. Premium rooms, world-class amenities, fine dining, and exceptional service.",
  keywords: "luxury hotel, fine dining, spa, resort, accommodations, booking",
  metadataBase: new URL("https://luxestay.com"),
  alternates: {
    canonical: "https://luxestay.com"
  },
  openGraph: {
    title: "Luxe Stay - Your Perfect Getaway Awaits",
    description: "Discover unparalleled comfort and elegance at our luxury hotel. Book your stay today.",
    siteName: "Luxe Stay",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vffk4xh1DqzFgStLz35sgQAAW/uploaded-1763996543217-zuxh0fkg.jpg",
      alt: "Luxury hotel lobby"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Stay - Luxury Hotel",
    description: "Experience world-class hospitality and premium accommodations.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vffk4xh1DqzFgStLz35sgQAAW/uploaded-1763996543217-zuxh0fkg.jpg"]
  },
  robots: {
    index: true,
    follow: true
